...
if("TRUE" STREQUAL "TRUE")
  set(rosbag_SOURCE_PREFIX /home/student/rosws/src/ros_comm-noetic-devel/tools/rosbag)
  set(rosbag_DEVEL_PREFIX /home/student/rosws/devel/.private/rosbag)
  set(rosbag_INSTALL_PREFIX "")
  set(rosbag_PREFIX ${rosbag_DEVEL_PREFIX})
else()
  set(rosbag_SOURCE_PREFIX "")
  set(rosbag_DEVEL_PREFIX "")
  set(rosbag_INSTALL_PREFIX /home/student/rosws/install)
...
if(NOT "/home/student/rosws/src/ros_comm-noetic-devel/tools/rosbag/include " STREQUAL " ")
  set(rosbag_INCLUDE_DIRS "")
  set(_include_dirs "/home/student/rosws/src/ros_comm-noetic-devel/tools/rosbag/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosbag' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/student/rosws/src/ros_comm-noetic-devel/tools/rosbag/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/student/rosws/devel/.private/rosbag/lib;/home/student/rosws/devel/lib;/opt/ros/melodic/lib)
