...
if("TRUE" STREQUAL "TRUE")
  set(rosserial_xbee_SOURCE_PREFIX /home/student/rosws/src/rosserial/rosserial_xbee)
  set(rosserial_xbee_DEVEL_PREFIX /home/student/rosws/devel/.private/rosserial_xbee)
  ...
  set(rosserial_xbee_INSTALL_PREFIX /home/student/rosws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosserial_xbee' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/student/rosws/src/rosserial/rosserial_xbee/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/student/rosws/devel/.private/rosserial_xbee/lib;/home/student/rosws/devel/lib;/opt/ros/melodic/lib)
