...
if("TRUE" STREQUAL "TRUE")
  set(rosnode_SOURCE_PREFIX /home/student/rosws/src/ros_comm-noetic-devel/tools/rosnode)
  set(rosnode_DEVEL_PREFIX /home/student/rosws/devel/.private/rosnode)
  set(rosnode_INSTALL_PREFIX "")
  set(rosnode_PREFIX ${rosnode_DEVEL_PREFIX})
else()
  set(rosnode_SOURCE_PREFIX "")
  set(rosnode_DEVEL_PREFIX "")
  set(rosnode_INSTALL_PREFIX /home/student/rosws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosnode' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/student/rosws/src/ros_comm-noetic-devel/tools/rosnode/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/student/rosws/devel/.private/rosnode/lib;/home/student/rosws/devel/lib;/opt/ros/melodic/lib)
