...
if("TRUE" STREQUAL "TRUE")
  set(rosserial_windows_SOURCE_PREFIX /home/student/rosws/src/rosserial/rosserial_windows)
  set(rosserial_windows_DEVEL_PREFIX /home/student/rosws/devel/.private/rosserial_windows)
  ...
  set(rosserial_windows_INSTALL_PREFIX /home/student/rosws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosserial_windows' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/student/rosws/src/rosserial/rosserial_windows/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/student/rosws/devel/.private/rosserial_windows/lib;/home/student/rosws/devel/lib;/opt/ros/melodic/lib)
